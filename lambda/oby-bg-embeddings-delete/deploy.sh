#!/usr/bin/env bash
#
# Builds, packages, and deploys code for the oby-bg-embeddings-delete Lambda
# function. The execution role, REST API, and S3 Vectors bucket/index are all
# created by infrastructure/infrastructure.yaml; this script only pushes new
...
FUNCTION_NAME="oby-bg-embeddings-delete"
DEPLOY_BUCKET="oby-bg-lambda-zips"
DEPLOY_KEY="oby-bg-embeddings-delete.zip"
